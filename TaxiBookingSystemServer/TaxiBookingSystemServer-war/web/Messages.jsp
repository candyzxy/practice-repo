<%-- 
    Document   : NewMessage
    Created on : Mar 14, 2017, 10:38:00 PM
    Author     : Derian
--%>
            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="Messages.jsp"><span class="glyphicon glyphicon-comment"></span>Messages</a></li> 
                    </ul>
                ...
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <form class="form-horizontal" role="form" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">                        
                                <input type = "hidden" name="nextAction" value="View Messages"/>
                                <input class="btn btn-primary" value="View Messages" type="submit"/>
                            </div>
                        </div>
                    </form>
                    <%
                ...
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <form class="form-horizontal" role="form" 
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"></label>
                            <div class="col-md-8">                        
                                <input type = "hidden" name="nextAction" value="Send Message"/>
                                <input class="btn btn-primary" value="Send Message" type="submit"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label">Send Message Status:</label>
